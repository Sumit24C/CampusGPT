...
export default function StudentEvents() {
    ...
    const HARD_CODED_EVENTS = [
        {
            ...
            description: "Hands-on workshop covering ML fundamentals and real-world use cases.",
            category: "Technical",
        ...
        },
        {
            ...
            description: "A celebration of music, dance, drama, and art across the campus.",
            category: "Cultural",
        ...
        },
        {
            ...
            description: "Athletics, football, basketball, and indoor games.",
            category: "Sports",
            date: "2026-03-25T08:00:00",
            day: "Wednesday",
            location: "Sports Complex",
            organizer: "Sports Cell",
            is_featured: false,
        },
        {
            id: 4,
            title: "Research Paper Writing Workshop",
            description: "Learn IEEE format, citations, and publication strategies.",
            category: "Academic",
        ...
        },
        {
            ...
            description: "A social initiative to support local hospitals.",
            category: "NSS",
    ...
    const [events, setEvents] = useState(HARD_CODED_EVENTS);
                        ...
                        <div className="flex items-center gap-3 overflow-x-auto">
                            ...
                            {categories.map((category) => (
                                <Button
                                    ...
                                    className={`h-9 rounded-xl px-4 text-xs font-medium whitespace-nowrap ${selectedCategory === category.toLowerCase()
